...
2. Paste the owned-site URL:
   `https://devenira.com/blog/the-most-important-reason-you-think-youre-not-losing-weight` — exact
   slug is `the-most-important-reason-you-think-youre-not-losing-weight` — verify against `posts.ts` (the file name's topic part is a hint, not always the exact slug)
...
## SEO Title
Why Am I Not Losing Weight Anymore? (It's Not You)
