...
2. Paste the owned-site URL:
   `https://devenira.com/blog/how-do-i-stop-a-binge-from-becoming-a-binge-week` — exact
   slug is `how-do-i-stop-a-binge-from-becoming-a-binge-week` — verify against `posts.ts` (the file name's topic part is a hint, not always the exact slug)
...
- Current owned-site hero: `/founder/diet-slip-checkin-20250725.jpg`
