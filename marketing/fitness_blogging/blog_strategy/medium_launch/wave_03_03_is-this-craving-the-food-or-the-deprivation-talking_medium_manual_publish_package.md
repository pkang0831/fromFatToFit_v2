...
2. Paste the owned-site URL:
   `https://devenira.com/blog/is-this-craving-the-food-or-the-deprivation-talking` — exact
   slug is `is-this-craving-the-food-or-the-deprivation-talking` — verify against `posts.ts` (the file name's topic part is a hint, not always the exact slug)
...
- Current owned-site hero: `/founder/cheat-day-founder-20251221.jpg`
...
Why does restriction make cravings worse? Usually because the food you forbid becomes the food your brain rehearses.
