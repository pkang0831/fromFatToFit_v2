...
2. Paste the owned-site URL:
   `https://devenira.com/blog/progress-update-4-the-body-finally-stopped-being-the-loud-thing` — exact
   slug is `progress-update-4-the-body-finally-stopped-being-the-loud-thing` — verify against `posts.ts` (the file name's topic part is a hint, not always the exact slug)
...
- Current owned-site hero: `/founder/final-body.jpg`
