...
2. Paste the owned-site URL:
   `https://devenira.com/blog/consistency` — exact
   slug is `consistency` — verify against `posts.ts` (the file name's topic part is a hint, not always the exact slug)
...
- Goal: calm, credible, anti-hype.
- Avoid glossy fitness-ad energy.
- Recommended asset: `marketing/fitness_blogging/selected_cut/final_cuts/pkang_0011 1.jpg`
...
Zoom out. Look for weekly direction. Stop giving one loud weigh-in the authority to rewrite the whole story.
