...
2. Paste the owned-site URL:
   `https://devenira.com/blog/why-your-workouts-feel-harder-when-youre-dieting` — exact
   slug is `why-your-workouts-feel-harder-when-youre-dieting` — verify against `posts.ts` (the file name's topic part is a hint, not always the exact slug)
