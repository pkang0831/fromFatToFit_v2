...
2. Paste the owned-site URL:
   `https://devenira.com/blog/weighing-yourself-every-day-can-be-a-trap-not-a-discipline` — exact
   slug is `weighing-yourself-every-day-can-be-a-trap-not-a-discipline` — verify against `posts.ts` (the file name's topic part is a hint, not always the exact slug)
...
## SEO Title
Daily Weighing: When It Becomes an Eating-Disorder Risk
...
- Current owned-site hero: `/founder/scale-rude-before-20240130.jpg`
...
The daily weighing eating disorder risk doesn't get talked about because the advice sounds disciplined. For some people it isn't.
