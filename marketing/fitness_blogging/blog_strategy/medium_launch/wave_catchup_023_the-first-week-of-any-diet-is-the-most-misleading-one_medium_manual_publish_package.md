...
2. Paste the owned-site URL:
   `https://devenira.com/blog/the-first-week-of-any-diet-is-the-most-misleading-one` — exact
   slug is `the-first-week-of-any-diet-is-the-most-misleading-one` — verify against `posts.ts` (the file name's topic part is a hint, not always the exact slug)
...
- Current owned-site hero: `/founder/start.jpg`
