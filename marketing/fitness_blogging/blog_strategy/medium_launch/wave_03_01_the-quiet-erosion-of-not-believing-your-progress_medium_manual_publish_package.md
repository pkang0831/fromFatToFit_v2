...
2. Paste the owned-site URL:
   `https://devenira.com/blog/the-quiet-erosion-of-not-believing-your-progress` — exact
   slug is `the-quiet-erosion-of-not-believing-your-progress` — verify against `posts.ts` (the file name's topic part is a hint, not always the exact slug)
...
- Current owned-site hero: `/founder/progress-update-hanok-20260119.jpg`
...
Here's how to trust slow weight loss progress when the days stop feeling like proof. Most of the work happens in the quiet stretch.
