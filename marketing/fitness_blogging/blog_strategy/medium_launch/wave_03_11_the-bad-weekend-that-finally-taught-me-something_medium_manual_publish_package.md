...
2. Paste the owned-site URL:
   `https://devenira.com/blog/the-bad-weekend-that-finally-taught-me-something` — exact
   slug is `the-bad-weekend-that-finally-taught-me-something` — verify against `posts.ts` (the file name's topic part is a hint, not always the exact slug)
...
- Current owned-site hero: `/founder/cheat-day-checkin-20250719.jpg`
...
Here's how to get back on track after a bad weekend without turning Monday into punishment. The fix isn't dramatic.
