...
2. Paste the owned-site URL:
   `https://devenira.com/blog/how-to-go-on-a-mirror-diet-when-the-real-diet-is-getting-loud` — exact
   slug is `how-to-go-on-a-mirror-diet-when-the-real-diet-is-getting-loud` — verify against `posts.ts` (the file name's topic part is a hint, not always the exact slug)
...
- Current owned-site hero: `/founder/founder-story-hanok-20260119.jpg`
...
Here's how to stop mirror checking on a diet that's actually working: look less, look better, and look in fewer states.
