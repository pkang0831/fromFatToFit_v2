...
2. Paste the owned-site URL:
   `https://devenira.com/blog/why-losing-5kg-in-a-week-usually-means-water-not-fat` — exact
   slug is `why-losing-5kg-in-a-week-usually-means-water-not-fat` — verify against `posts.ts` (the file name's topic part is a hint, not always the exact slug)
...
## SEO Title
Is Losing 5 kg in a Week Water Weight?
