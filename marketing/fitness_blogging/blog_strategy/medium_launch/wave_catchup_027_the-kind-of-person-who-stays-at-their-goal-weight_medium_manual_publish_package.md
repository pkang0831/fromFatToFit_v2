...
2. Paste the owned-site URL:
   `https://devenira.com/blog/the-kind-of-person-who-stays-at-their-goal-weight` — exact
   slug is `the-kind-of-person-who-stays-at-their-goal-weight` — verify against `posts.ts` (the file name's topic part is a hint, not always the exact slug)
