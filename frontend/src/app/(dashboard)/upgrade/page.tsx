...
export default function UpgradePage() {
  ...
  const pricing = {
    monthly: { price: 9.99, priceId: 'price_1TGuQACIAtieotxAy7HsfRhq', period: 'month' },
    yearly: { price: 89.99, priceId: 'price_1TGuQ8CIAtieotxAQiWLJAou', period: 'year', savings: 'Save 25%' },
  };
